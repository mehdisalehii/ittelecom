<li class="display-flex header">
    ...
    <div class="col-4">شرح کالا</div>
    <div class="col-2">تعداد موجودی کالا</div>
    <div class="col-5">ابزار</div>
</li>
...
<li class="content-ma display-flex lid">
    ...
    <div class="col-2">{{ \Morilog\Jalali\CalendarUtils::convertNumbers( number_format ( $row->number ,0,'',',') ) }} عدد</div>
