<li class="display-flex header">
    <div class="col-1">شماره فاکتور</div>
    <div class="col-2">تاریخ صدور</div>
    <div class="col-2">نام خریدار</div>
    <div class="col-1">نام فروشنده</div>
    <div class="col-1">نوع فاکتور</div>
    <div class="col-2">مبلغ (ریال)</div>
    <div class="col-1">نام صادرکننده</div>
...
@foreach($invoices as $row)
    <li class="content-ma display-flex lid">
        ...
        <div class="col-1 txt badge-list">
            <span class="@if( URL::current() != route('admin.invoice.index') ){{'badge badge-info red'}}@else{{'default'}}@endif">
        ...
        @endphp
            ...
            <a class="btn btn-update text-white" href="{{  '/invoice/' . $row->order_no .'/'. $orientation .'/'. $row->hash .'.pdf' }}" target="_blank" title="چاپ"><i class="icn white" style="background-image: url(/icons/printer.svg);"></i></a>
