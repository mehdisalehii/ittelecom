...
$(document).ready(function () {
    ...
    $("#submit").click(function () {
        ...
        var val_data = {
            ...
            content_bottom: tinymce.get('content_bottom').getContent(),
            type: $("#type").val(),
            sku: $("#sku").val(),
            id: $("#id").val()
        };
        ...
        $.ajax({
            ...
            success: function (data) {
                if (val_data.id) {
                    ...
                    $('#short_description_show' + val_data.id).html(val_data.short_description);
                    $('#content_show' + val_data.id).html(val_data.content);
                    $('#content_bottom_show' + val_data.id).html(val_data.content_bottom);
                    ...
                    $('.edit-button[id="' + val_data.id + '"]').attr('short_description', val_data.short_description);
                    $('.edit-button[id="' + val_data.id + '"]').attr('content', val_data.content);
                    $('.edit-button[id="' + val_data.id + '"]').attr('content_bottom', val_data.content_bottom);
                ...
                $('#content_bottom').val('');
                tinymce.get('content_bottom').setContent('');
                $('#sku').val('');
                $('#type').val('');
                $('#id').val('');
                $("#load").hide();
    ...
    $(document).on("click", ".edit-button", function () {
        ...
        var short_description = $(this).attr('short_description');
        ...
        $("#short-description").val(short_description);
        tinymce.get('content').setContent(content);
        tinymce.get('content_bottom').setContent(content_bottom);
        $("#sku").val(sku);
        $("#type").val(type);
