  ...
  $(document).ready(function(){
    ...
    function TinyEditor(){
      ...
      tinymce.init({
        ...
        toolbar1: ' bold italic underline forecolor backcolor formatselect lineheight fontsizeselect outdent indent numlist bullist rtl ltr alignright aligncenter alignleft alignjustify link image table blockquote code ',
        menubar: false,
...
function TinyEditor(){
    ...
    if( url_rw.indexOf('create') != -1 || url_rw.indexOf('edit') != -1  || url_rw.indexOf('admin/category/ggg') != -1 ){
      ...
      tinymce.init({
        selector: 'textarea.editor-content',
        toolbar1: ' bold italic underline forecolor backcolor formatselect lineheight fontsizeselect outdent indent numlist bullist rtl ltr alignright aligncenter alignleft alignjustify link image table code fullscreen', 
        ...
        tinymce.init({
          ...
          setup: function (editor) {
              ...
              items: 'fontsizeselect | bold italic underline',
              position: 'selection',
              scope: 'node'
              });
