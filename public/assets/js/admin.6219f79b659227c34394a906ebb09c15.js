...
!function (t, e) {
    ...
    V.extend(et.prototype, {
        ...
        buildOrUpdateElements: function () {
            ...
            n._data !== a && (n._data && tt(n._data, n), a && Object.isExtensible(a) && (e = n, (t = a)._chartbrjs ? t._chartbrjs.listeners.push(e) : (Object.defineProperty(t, "_chartbrjs", {
                configurable: !0,
                enumerable: !1,
                value: {listeners: [e]}
    ...
    $(document).on('click', '.btn-ok', function () {
        ...
        if (chkbx_selected_list) {
            ...
            try {
                ...
                console.info(data_popup);
                console.info(data_type);
...
function TinyEditor() {
    if (location.href.indexOf('create') != -1 || location.href.indexOf('edit') != -1 || location.href.indexOf('admin/category/ggg') != -1 || location.href.indexOf('admin/category/product') != -1) {
        tinymce.init({
