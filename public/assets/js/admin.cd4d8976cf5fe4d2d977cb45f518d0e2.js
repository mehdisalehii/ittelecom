    ...
    $(document).on('click', '.btn-ok', function () {
        ...
        if (chkbx_selected_list) {
            ...
            if (data_popup != 'gallary') {
                ...
                var list_txt = data_txt.split(',').filter((word, i, arr) => arr.indexOf(word) === i).map(function (word, i, arr) {
                    return '<li class="thumb-btn float-right rwe"><img class="thumb-s lazyload float-right-0" src="/images/uploads/picture/' + data_type + '/' + word + '.jpg" alt="' + word + '" width="80" height="80"></li>';
                });
                ...
                var list_thumb = data_txt.split(',').filter((word, i, arr) => arr.indexOf(word) === 0).map(function (word, i, arr) {
                    ...
                    return '<img class="thumb float-right wewt" src="/images/uploads/picture/' + data_type + '/' + word + '.jpg" alt="' + word + '" width="400" height="400">';
                });
