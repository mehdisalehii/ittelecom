...
$(document).ready(function()
{
  ...
  $(document).ready(function(){
    ...
    $(document).on("click",".del-button",function() {
        ...
        AlertConfirm('حذف','آیا میخواهید شماره '+id+' را حذف شود؟','بــلـه!')
    ...
    function TinyEditor(){
      ...
      tinymce.init({
        ...
        toolbar1: ' bold italic underline forecolor backcolor formatselect lineheight fontsizeselect outdent indent numlist bullist rtl ltr alignright aligncenter alignleft alignjustify link image table blockquote code removeformat',
        menubar: false,
        ...
        contextmenu: 'bold image fontsizeselect fontselect table formatselect h1 italic lineheight undo redo styleselect alignleft aligncenter alignright alignjustify outdent indent',
        ...
        setup: function (editor) {
            ...
            items: 'fontsizeselect | bold underline | indent | numlist bullist | table | rtl ltr | link | alignright aligncenter alignleft alignjustify',
            position: 'selection',
            scope: 'node'
            });
...
function TinyEditor(){
    ...
    if( url_rw.indexOf('create') != -1 || url_rw.indexOf('edit') != -1  || url_rw.indexOf('admin/category/ggg') != -1 ){
      ...
      tinymce.init({
        selector: 'textarea.editor-content',
        toolbar1: ' bold italic underline forecolor backcolor formatselect lineheight fontsizeselect outdent indent numlist bullist rtl ltr alignright aligncenter alignleft alignjustify link image table code removeformat fullscreen',
        ...
        setup: function (editor) {
          ...
          predicate: function (node) {
            ...
            items: 'fontsizeselect  lineheight formatselect bold underline indent numlist bullist image table rtl ltr link alignright aligncenter alignleft alignjustify',
            position: 'selection',
            scope: 'node'
          });
        ...
        tinymce.init({
          ...
          setup: function (editor) {
              ...
              items: 'fontsizeselect | bold italic underline removeformat',
              position: 'selection',
              scope: 'node'
              });
   ...
   function invoice_code( $type, $total_number_item ) {
    ...
    $(document).on('click', '.btn-ok', function(){
      ...
      if ( chkbx_selected_list ) {
        ...
        var list_input = data_txt.split(',').filter((word, i, arr) => arr.indexOf(word) === i).map(function(word, i, arr) { return word; });
        ...
        if ( data_popup != 'gallary' ) {
          ...
          var list_txt = data_txt.split(',').filter((word, i, arr) => arr.indexOf(word) === i).map(function(word, i, arr) { return '<li class="thumb-btn float-right rwe"><img class="thumb-s lazyload float-right-0" src="/images/uploads/picture/' + data_type + '/' + word + '.jpg?w=300&h=300" alt="' + word + '" width="80" height="80"><input type="checkbox" class="delete_item" title="حذف" name="delete_item_chkbox" data-popup="'+ data_popup +'" value="' + word + '" checked="checked" data-type="' + data_type + '"></li>'; });
  
          var list_thumb = data_txt.split(',').filter((word, i, arr) => arr.indexOf(word) === 0).map(function(word, i, arr) { return '<img class="thumb float-right wewt" src="/images/uploads/picture/' + data_type + '/' + word + '.jpg" alt="' + word + '" width="400" height="400">'; });
...
$(document).on('click','.btn-delete-row',function(){
  ...
  AlertConfirm('حذف لیست','آیا میخواهید '+data_txt+' را حذف شود؟','بــلـه!')
...
$(document).on('click','.delete-btn-sql',function(event){
  ...
  AlertConfirm('حذف','آیا میخواهید '+data_txt+' را حذف شود؟','بــلـه!')
...
$(document).on('click', '.delete-page', function(event){
    ...
    AlertConfirm('حذف صفحه','آیا میخواهید صفحه '+data_id+' را حذف شود؟','بــلـه!')
    $(document).ready(function () {
      $('.btn-yes-done').on('click', function () {
        setTimeout(function(){
